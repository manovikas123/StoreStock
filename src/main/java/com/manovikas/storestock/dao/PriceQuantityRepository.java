...
public interface PriceQuantityRepository extends JpaRepository<PriceQuantity,Integer> {
    Optional<Integer> findIdByBrandIdAndPriceItem(int brandId, Integer priceItem);
    Optional<PriceQuantity> findByPriceItemAndBrandId(@Param("priceItem") Integer priceItem, @Param("brandId") Integer brandId);
